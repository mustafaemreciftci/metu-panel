  ...
  if (loaded) {
    return (
      <div className="w-full md:w-[88vw] md:pl-[14vw] bg-white min-h-screen">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              ...
              <div className="relative">
                ...
                {showFilters && (
                  <div className="absolute right-0 mt-2 w-80 bg-[#F0F0F0] rounded-lg shadow-lg border border-gray-200 p-4 z-50">
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-around space-x-2 pt-2">
                        <button
                          ...
                          className="text-md text-[#7057DD] bg-[#E4E1F4] px-3 py-1 w-32 rounded hover:bg-[#7057DD] hover:text-[#E4E1F4]"
                        >
                          Temizle
                        </button>
                        ...
                        <button
                          ...
                          className="text-md bg-[#7057DD] text-white px-3 py-1 w-32 rounded hover:bg-[#E4E1F4] hover:text-[#7057DD]"
                        >
                          Uygula
                        </button>
                      </div>
        ...
        {/* Calendar Grid - exactly like class-program */}
        <div className="px-2 md:p-2 flex justify-center items-center min-h-[calc(100vh-300px)]">
          <div className="bg-white w-full">
            ...
            {currentView === "month" ? (
              /* Custom Calendar Grid - responsive like class-program */
                            ...
                            {(filterEvents !== null ? filterEvents : events)
                              ...
                              .map((event: any, index: number) => {
                                const instructorName =
                                  event.instructor?.substring(0, 15) ||
                                  "UNKNOWN";
                                const shortName = instructorName.substring(
                                  0,
                                  10
                                ); // Shorter for mobile
                                ...
                                return (
                                  <div
                                    key={index}
                                    className="text-xs px-1 md:px-2 py-1 rounded-sm cursor-pointer hover:opacity-80 bg-blue-100 text-blue-800"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      onSelectEvent(event);
                                    }}
              ...
              <div className="flex justify-center items-center h-[60vh] md:h-[75vh]">
                <Calendar
                  ...
                  eventPropGetter={(event: any) => {
                    ...
                    if (event.is_main) {
                      backgroundColor = "#fca5a5"; // Red for department meetings
                    } else {
                      backgroundColor = "#bfdbfe"; // Blue for regular meetings
                    }
                  ...
                  components={{
                    event: ({ event }: { event: any }) => (
                      <div className="text-xs font-medium truncate">
                        {event.instructor?.substring(0, 15) || "UNKNOWN"}
                      </div>
                    ),
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-center space-x-3 mt-6">
                <input
                  ...
                  onChange={() => setUpdateIsMain(!updateIsMain)}
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                />
                <label htmlFor="updateIsMain" className="text-sm text-black">
                  Bölüm başkanlığı toplantısı için bu kutucuğu işaretleyin.
                </label>
              </div>
            </div>
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-center space-x-3 mt-6">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                />
                <label htmlFor="isMain" className="text-sm text-black">
                  Bölüm başkanlığı toplantısı için bu kutucuğu işaretleyin.
                </label>
              </div>
            </div>
            ...
            <div className="flex justify-end pt-4">
              <button
                ...
                className="bg-[#22C2BA] text-white px-6 py-3 rounded-lg hover:bg-[#1da39a] flex items-center justify-center space-x-2 w-full md:w-auto"
              >
                <span>+ Kaydet</span>
              </button>
            </div>
